...
export default function Introduction() {
  return (
    <div className="space-y-12">
      ...
      <div className="text-nordic-text">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-nordic-border mb-8">
          <h3 className="text-xl font-semibold text-nordic-blue mb-4">Vision 2030 krever at vi:</h3>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-nordic-border">
            <div className="flex items-center gap-3 mb-4">
              <BookOpen className="text-nordic-accent" />
              <h3 className="text-xl font-semibold text-nordic-blue m-0">Hva Playbooken ER</h3>
            </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-nordic-border">
            <div className="flex items-center gap-3 mb-4">
              <XCircle className="text-nordic-text-muted" />
              <h3 className="text-xl font-semibold text-nordic-blue m-0">Hva Playbooken IKKE er</h3>
            </div>
            <ul className="space-y-2 text-sm text-nordic-text-muted">
        ...
        <h3 className="text-2xl font-semibold text-nordic-blue mb-4">Hvem er den for?</h3>
        <div className="grid sm:grid-cols-2 gap-4">
          {[
            ...
            <div key={i} className="flex gap-4 p-4 bg-nordic-bg rounded-lg border border-nordic-border">
              <Users className="text-nordic-blue shrink-0" size={24} />
              <div>
                <h4 className="font-semibold text-nordic-blue m-0">{item.role}</h4>
                <p className="text-sm text-nordic-text m-0 mt-1">{item.desc}</p>
              </div>
            </div>
          ))}
        </div>
